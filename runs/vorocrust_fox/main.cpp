...
{
    // READ HERE POINTS
    std::vector<double> in_seeds_x = read_vector("/home/itamarg/workspace/RICH/VoroCrust/output/fox/dump/zone_in_volume_seeds/x.txt");
    std::vector<double> in_seeds_y = read_vector("/home/itamarg/workspace/RICH/VoroCrust/output/fox/dump/zone_in_volume_seeds/y.txt");
    std::vector<double> in_seeds_z = read_vector("/home/itamarg/workspace/RICH/VoroCrust/output/fox/dump/zone_in_volume_seeds/z.txt");

    std::vector<double> out_seeds_x = read_vector("/home/itamarg/workspace/RICH/VoroCrust/output/fox/dump/zone_out_seeds/x.txt");
    std::vector<double> out_seeds_y = read_vector("/home/itamarg/workspace/RICH/VoroCrust/output/fox/dump/zone_out_seeds/y.txt");
    std::vector<double> out_seeds_z = read_vector("/home/itamarg/workspace/RICH/VoroCrust/output/fox/dump/zone_out_seeds/z.txt");
